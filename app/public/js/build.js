...
var BLOG_URL = "http://blog.miguhruiz.xyz";
...
function renderSkills(badge, name) {
  var clone = activateTemplate('.stack');

  clone.querySelector('.stack-image').src = badge;
  clone.querySelector('.stack-title').innerHTML = name;

  (0, _jquery2['default'])('.stacks').append(clone);
}

function renderPost(thumbnail, name, url) {
  var post_url = BLOG_URL + url;
  var clone = activateTemplate('.post');
  ...
  (0, _jquery2['default'])('.posts').append(clone);
}

_jquery2['default'].getJSON('/data/skills', function (data) {
...
_jquery2['default'].getJSON('/latest-posts', function (data) {
